...
/**
 * Theme Settings settings page functions.
 *
    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p class="warning">' . sprintf( __( 'Go to the %s page if you want to save data, this page is for adding settings.', 'option-tree' ), '<a href="' . get_admin_url( $blog_id, 'themes.php?page=ot-theme-options' ) . '"><code>Appearance->Theme Settings</code></a>' ) . '</p>';
          echo '<p class="warning">' . sprintf( __( 'If you\'re unsure or not completely positive that you should be editing these settings, you should read the %s first.', 'option-tree' ), '<a href="' . get_admin_url( $blog_id, 'admin.php?page=ot-documentation' ) . '"><code>Theme Settings->Documentation</code></a>' ) . '</p>';
          ...
          echo '<p>' . __( 'You can create as many settings as your project requires and use them how you see fit. When you add a setting here, it will be available on the Theme Settings page for use in your theme. To separate your settings into sections, click the "Add Section" button, fill in the input fields, and a new navigation menu item will be created.', 'option-tree' ) . '</p>';
    ...
    echo '<form method="post" id="import-xml-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . __( 'If you were given a Theme Settings XML file with a premium or free theme, locate it on your hard drive and upload that file by clicking the blue upload button. A popup window will appear, upload the XML file and click "Send to Theme Settings". The file URL should be in the upload input, if it is click "Import XML".', 'option-tree' ) . '</p>';
    ...
    echo '<form method="post" id="import-data-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          /*echo '<p>' . __( 'Only after you\'ve imported the Settings should you try and update your Theme Settings.', 'option-tree' ) . '</p>';
          
          echo '<p>' . __( 'To import your Theme Settings copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Theme Settings" button.', 'option-tree' ) . '</p>';*/
          echo '<p>' . __( 'Import default values.', 'awesomeapp' ) . '</p>';
          
          /* button */
          echo '<button class="option-tree-ui-button grey right hug-right">' . __( 'Import Theme Settings', 'option-tree' ) . '</button>';
  ...
  function ot_type_export_settings() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Export your Settings by highlighting this text and doing a copy/paste into a blank .txt file. Then save the file for importing into another install of WordPress later. Alternatively, you could just paste it into the <code>Theme Settings->Settings->Import</code> <strong>Settings</strong> textarea on another web site.', 'option-tree' ) . '</p>';
  ...
  function ot_type_export_data() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Export your Theme Settings data by highlighting this text and doing a copy/paste into a blank .txt file. Then save the file for importing into another install of WordPress later. Alternatively, you could just paste it into the <code>Theme Settings->Settings->Import</code> <strong>Theme Settings</strong> textarea on another web site.', 'option-tree' ) . '</p>';
  ...
  function ot_type_export_layouts() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Export your Layouts by highlighting this text and doing a copy/paste into a blank .txt file. Then save the file for importing into another install of WordPress later. Alternatively, you could just paste it into the <code>Theme Settings->Settings->Import</code> <strong>Layouts</strong> textarea on another web site.', 'option-tree' ) . '</p>';
    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . __( 'When you create a new layout it will become active and any changes made to the Theme Settings will be applied to it. If you switch back to a different layout immediately after creating a new layout that new layout will have a snapshot of the current Theme Settings data attached to it.', 'option-tree' ) . '</p>';
          echo '<p>' . __( 'Visit <code>Theme Settings->Documentation->Layouts Overview</code> to see a more in-depth description of what layouts are and how to use them.', 'option-tree' ) . '</p>';
