 ...
 * Description: Theme Settings UI Builder for WordPress. A simple way to create & save Theme Settings and Meta Boxes for free or premium themes.
 * Version:     2.0.16
 * Author:      Derek Herman
...
/**
 * This is the Theme Settings loader class.
 *
...
if ( ! class_exists( 'OT_Loader' ) ) {
  ...
  class OT_Loader {
     ...
     * Constants
     *
     * Defines the constants for use within Theme Settings. Constants 
    ...
    private function constants() {
       ...
       *
       * Run a filter and set to true to enable Theme Settings theme mode.
       ...
       *
       * Run a filter and set to true to enable Theme Settings child theme mode.
       * You must have this files parent directory inside of 
       * your themes root directory. As well, you must include 
       * a reference to this file in your themes functions.php.
       *
       ...
       * "New Layout" section at the top of the Theme Settings page.
       *
       * @since     2.0.10
       */
       ...
       *
       * Run a filter and set to false to keep Theme Settings from
      ...
      if ( false == OT_THEME_MODE && false == OT_CHILD_THEME_MODE ) {
        ...
        if ( true == OT_CHILD_THEME_MODE ) {
          define( 'OT_DIR', trailingslashit( get_stylesheet_directory() ).'/includes/'. trailingslashit( basename( dirname( __FILE__ ) ) ) );
          define( 'OT_URL', trailingslashit( get_stylesheet_directory_uri() ).'/includes/'. trailingslashit( basename( dirname( __FILE__ ) ) ) );
        } else {
          define( 'OT_DIR', trailingslashit( get_template_directory() ) .'/includes/'. trailingslashit( basename( dirname( __FILE__ ) ) ) );
          define( 'OT_URL', trailingslashit( get_template_directory_uri() ) .'/includes/'. trailingslashit( basename( dirname( __FILE__ ) ) ) );
        }
      }
  ...
  /**
   * Instantiate the Theme Settings loader class.
   *
   * @since     2.0
   */
