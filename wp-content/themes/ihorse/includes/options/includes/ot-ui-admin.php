      ...
      array(
        ...
        'pages'               => apply_filters( 'ot_register_pages_array', array( 
          ...
          array(
            ...
            'reset_message'   => __( 'Theme Settings reset.', 'option-tree' ),
            ...
            'sections'        => array(
              array(
                'id'          => 'create_setting',
                'title'       => __( 'Theme Settings UI', 'option-tree' )
              ),
              array(
                'id'          => 'import',
            ...
            'settings'        => array(
              array(
                ...
                'label'       => __( 'Theme Settings UI Builder', 'option-tree' ),
              ...
              array(
                'id'          => 'import_data_text',
                'label'       => __( 'Theme Settings', 'option-tree' ),
                'type'        => 'import-data',
                'section'     => 'import'
              ),
              array(
