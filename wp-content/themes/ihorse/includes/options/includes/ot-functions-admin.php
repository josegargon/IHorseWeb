...
/**
 * Runs directly after the Theme Settings are save.
 *
 * @return    void
 *
 * @access    public
...
if ( ! function_exists( 'ot_after_theme_options_save' ) ) {
  ...
  function ot_after_theme_options_save() {
    ...
    /* only execute after the Theme Settings are saved */
    if ( 'ot-theme-options' == $page && $updated ) {
      
      /* grab a copy of the Theme Settings */
      $options = get_option( 'option_tree' );
      
      /* execute the action hook and pass the Theme Settings to it */
 ...
 * @uses      wp_enqueue_script()     Add Theme Settings scripts
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => __( 'Send to Theme Settings', 'option-tree' ),
...
if ( ! function_exists( 'ot_import' ) ) {
  ...
  function ot_import() {
    ...
    /* check and verify import Theme Settings data nonce */
...
' . implode( ",\n", $setting_std_array ) . '
    ...
    $content.= "<?php
/**
 * Initialize the custom Theme Settings.
 */
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Settings page.', 'option-tree' ) . '</div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Settings page.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Settings page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>Theme Settings->Documentation</code> for more information on which ones.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Settings page.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      foreach( $settings as $field ) {
        ...
        /* option label */
        echo '<div class="format-settings '.$_args['field_class'].'">';
...
/**
 * Helper function to display Theme Settings layouts form.
 *
 * @return    string
 *
 * @access    public
